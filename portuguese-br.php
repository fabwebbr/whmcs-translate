...
$_LANG['affiliatesWithdrawalRequestUnsuccessful'] = "Seu pedido de saque não foi bem-sucedido. Por favor, tente novamente mais tarde.";
...
$_LANG['nokbcategories'] = "Nenhuma categoria";
...
$_LANG['networkIssuesScheduled'] = "Existem eventos de manutenção futuros que podem afetar nossos serviços.";
...
$_LANG['viewAllPricing'] = "Todos os preços";
...
$_LANG['cartapifailedtoloadcart'] = "O sistema não pôde carregar o carrinho solicitado. <strong><a href=\"cart.php\">Clique aqui</a></strong> para gerar um novo pedido.";
...
$_LANG['domaincheckerdomainexample'] = " ex: sua-empresa.com";
...
$_LANG['twofaenforced'] = "O administrador do sistema impôs que você deve ativar a autenticação de dois fatores antes de continuar. Esta página irá guiá-lo através do processo de configuração.";
...
$_LANG['twoipconnect'] = "Connecte seu App";
$_LANG['twoipinstruct'] = "Usando um aplicativo autenticador como %s ou %s, escaneie o código QR abaixo. Tendo problemas para escanear o código? Digite o código manualmente:";
...
$_LANG['domaincontactdetails']['Phone Country Code'] = "Código DDI";

$_LANG['serverhostnameexample'] = "Ex. SeuServer(.exemplo.com)";
...
$_LANG['customActionGenericError'] = "Incapaz de executar a ação. Entre em contato com o suporte.";
...
$_LANG['clientHomePanels']['unpaidInvoices'] = "Fatura(s) não paga(s)";
$_LANG['clientHomePanels']['unpaidInvoicesMsg'] = "Você tem :numberOfInvoices fatura(s) não paga(s) com um saldo total devido de :balanceDue.";
$_LANG['clientHomePanels']['overdueInvoices'] = "Faturas em atraso";
$_LANG['clientHomePanels']['overdueInvoicesMsg'] = "Você tem :numberOfInvoices fatura(s) em atraso(s) com um saldo total devido de :balanceDue. Pague agora para evitar a suspensão de seu(s) serviço(s)";
...
$_LANG['clientHomePanels']['productsAndServices'] = "Nossos Produtos e Serviços";

$_LANG['upgradeNotPossible'] = "Atualizar este produto não é possível. Se você acredita que você chegou a esta página por engano, por favor notifique o nosso departamento de suporte. Caso contrário, volte e verifique a sua selecção.";
$_LANG['upgradeSameProductMustExtendCycle'] = "Para atualizar seu ciclo de cobrança, escolha um ciclo maior que o seu ciclo de cobrança atual.";
...
$_LANG['usageStatsBwLimitNear'] = "Você está se aproximando de seu limite de tráfego.";
$_LANG['usageStatsDiskLimitNear'] = "Você está se aproximando de seu limite de espaço em disco.";
$_LANG['usageUpgradeNow'] = "Fazer Upgrade";
...
$_LANG['orderForm']['errorNoGateways'] = "Nenhum gateway de pagamento disponível, então o pedido não pode prosseguir";
$_LANG['orderForm']['errorUnavailableGateway'] = "O gateway selecionado não está disponível. Escolha uma opção na seção Detalhes de pagamento.";
...
$_LANG['markdown']['exampleLink'] = "https://www.exemplo.com";
...
$_LANG['ssl']['emailMethodDescription'] = "A validação será realizada pela Autoridade Certificadora, enviando um e-mail com maiores instruções para o endereço abaixo indicado.";
$_LANG['ssl']['dnsMethodDescription'] = "A Autoridade Certificadora irá inspecionar os registros DNS do domínio, procurando por um registro específico com um valor único. Certifique-se de ter acesso para administrar as configurações de DNS do domínio para concluir esta configuração. As informações do registro DNS serão fornecidas após a configuração bem-sucedida.";
$_LANG['ssl']['fileMethodDescription'] = "A autoridade de certificação fará uma solicitação HTTP para um caminho hospedado no domínio, esperando que a resposta contenha um valor exclusivo. O caminho e o valor serão fornecidos após a configuração bem-sucedida.";
...
$_LANG['fraud']['furtherVal'] = "Verificação adicional é necessária para processar seu pedido. Clique no botão e siga as etapas para o processo de envio seguro. Você terminará em menos de um minuto.";
$_LANG['fraud']['furtherValShort'] = "Verificação adicional é necessária. Clique no botão e siga as etapas fornecidas.";
...
$_LANG['support']['ticketError'] = "Não podemos processar sua solicitação no momento. Por favor, tente novamente mais tarde.";
...
$_LANG['errors']['tryAgainOrSupport'] = "Tente novamente mais tarde ou <a href=\"submitticket.php\">fale conosco</a>.";
...
$_LANG['navUserManagement'] = "Gerenciar usuários";
$_LANG['navSwitchAccount'] = "Trocar usuário";
$_LANG['navAccountSecurity'] = "Segurança";
...
$_LANG['emailVerification']['notFound'] = "Desculpe, não foi possível encontrar uma verificação pendente correspondente à sua solicitação.";
$_LANG['emailVerification']['loginToRequest'] = "Faça login para solicitar um novo link de verificação de e-mail.";

$_LANG['switchAccount']['title'] = "Trocar conta";
$_LANG['switchAccount']['choose'] = "Escolha a conta que irá gerenciar";
$_LANG['switchAccount']['noneFound'] = "Nenhuma conta encontrada";
$_LANG['switchAccount']['createInstructions'] = "Para criar uma nova conta, você precisa fazer um novo pedido.";
$_LANG['switchAccount']['noLongerActive'] = "Esta conta não está ativa";
$_LANG['switchAccount']['invalidChooseAnother'] = "Conta inválida. Tente novamente.";
$_LANG['switchAccount']['cancelAndReturn'] = "Cancelar e retornar";
...
$_LANG['clientOwner'] = "Dono";

$_LANG['userManagement']['title'] = "Gerenciar usuários";
$_LANG['userManagement']['managePermissions'] = "Gerenciar Permissões";
$_LANG['userManagement']['permissions'] = "Permissões";
$_LANG['userManagement']['usersFound'] = ":count Usuário(s) Encontrado(s)";
$_LANG['userManagement']['userDescriptor'] = "E-mail / Último Login";
...
$_LANG['userManagement']['alreadyInvited'] = "O endereço de e-mail inserido já tem um convite ativo.";
...
$_LANG['userProfile']['changeEmail'] = "Alterar enderçeo de e-mail";
...
$_LANG['accountInvite']['givenAccess'] = ":ot:senderName:ct deu-lhe acesso à :ot:clientName:ct";
...
$_LANG['accountInvite']['emailAlreadyExists'] = "Já existe um usuário com esse endereço de e-mail. Por favor, faça o login ou use um e-mail diferente.";
$_LANG['accountInvite']['notFound'] = "Desculpe, não foi possível encontrar um convite pendente correspondente à sua solicitação.";
...
$_LANG['permissions']['descriptions']['products'] = "Veja o acesso a produtos, serviços e complementos";
...
$_LANG['permissions']['descriptions']['managedomains'] = "Permitir gerenciar domínios. Ex: DNS/Whois/Transferências";
$_LANG['permissions']['descriptions']['invoices'] = "Visualização e acesso ao pagamento de faturas";
$_LANG['permissions']['descriptions']['quotes'] = "Ver e aceitar permissões para cotações";
$_LANG['permissions']['descriptions']['tickets'] = "Acesso para abrir, responder e gerenciar tickets de suporte";
...
$_LANG['permissions']['descriptions']['orders'] = "Permitir a colocação de novos pedidos";

$_LANG['closed'] = "Fechado";
$_LANG['noPermission'] = "Sem permissão";

$_LANG['domainDetails']['error']['getNs'] = "Houve um problema ao obter os servidores de nomes de domínio. Entre em contato com o suporte.";
$_LANG['domainDetails']['error']['saveNs'] = "Houve um problema ao atualizar os servidores de nomes de domínio. Entre em contato com o suporte.";
...
$_LANG['domainDetails']['error']['saveContact'] = "Houve um problema ao salvar os detalhes de contato do domínio. Entre em contato com o suporte.";
$_LANG['domainDetails']['error']['getDns'] = "Houve um problema ao recuperar os registros DNS. Entre em contato com o suporte.";
$_LANG['domainDetails']['error']['saveDns'] = "Houve um problema ao salvar os registros DNS. Entre em contato com o suporte.";
$_LANG['domainDetails']['error']['getEmailFwd'] = "Houve um problema ao recuperar os encaminhadores de e-mail. Entre em contato com o suporte.";
$_LANG['domainDetails']['error']['saveEmailFwd'] = "Houve um problema ao atualizar os encaminhadores de e-mail. Entre em contato com o suporte.";
...
$_LANG['domainDetails']['error']['resendNotification'] = "Houve um problema ao reenviar o e-mail de notificação. Entre em contato com o suporte.";
...
$_LANG['support']['requestor']['owner'] = "Dono";
...
$_LANG['twoFactor']['enabled'] = "Autenticação de dois fatores Habilitado";
$_LANG['twoFactor']['disabled'] = "Autenticação de dois fatores Disabilitado";
...
$_LANG['orderForm']['idnNotEnabled'] = "Não oferecemos suporte a nomes de domínio internacionais no momento. Tente um nome de domínio diferente.";
...
$_LANG['searchOurKnowledgebase'] = "Procurar base de conhecimento";
$_LANG['browseProducts'] = "Nossos Produtos";
$_LANG['secureYourDomain'] = "Registre seu domínio hoje!";
$_LANG['secureYourDomainShort'] = "Registre seu domínio";
$_LANG['transferYourDomain'] = "Transferir domínio";
$_LANG['transferExtend'] = "Transfer now to extend your domain by 1 year";
$_LANG['howCanWeHelp'] = "Como posso te ajudar?";
...
$_LANG['userLogin']['signInToContinue'] = "Faça login para continuar.";
$_LANG['userLogin']['notRegistered'] = "Sem registro?";

$_LANG['networkIssues']['scheduled'] = "Existe(m) :count possível(is) impacto(s) na rede.";
$_LANG['networkIssues']['http'] = "HTTP";
$_LANG['networkIssues']['ftp'] = "FTP";
$_LANG['networkIssues']['pop3'] = "POP3";
$_LANG['networkIssues']['affectingYou'] = "Este problema pode impactar seu serviço";
...
$_LANG['recommendations']['explain']['ordered'] = "Como você solicitou <strong>:productName</strong>, nós recomendamos:";
$_LANG['recommendations']['learnMore'] = "Clique para aprender mais.";
$_LANG['recommendations']['productAdded'] = "Produto Adicionado";
$_LANG['recommendations']['taglinePlaceholder'] = "Uma descrição (Tag) não está disponível para este produto.";
...
$_LANG['usagebilling']['metric']['subDomains'] = "Sub Domínios";
$_LANG['usagebilling']['metric']['mysqlDatabases'] = "Bancos MySQL";
...
$_LANG['idna']['labelTooLong'] = "O nome de domínio excedeu o comprimento máximo.";
